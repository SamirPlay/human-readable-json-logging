...
[![build](https://github.com/unselfishmaso/human-readable-json-logging/actions/workflows/ci.yaml/badge.svg)](https://github.com/unselfishmaso/human-readable-json-logging/actions/workflows/ci.yaml)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/unselfishmaso/human-readable-json-logging)](https://goreportcard.com/report/github.com/unselfishmaso/human-readable-json-logging)
[![Go Reference](https://pkg.go.dev/badge/github.com/unselfishmaso/human-readable-json-logging.svg)](https://pkg.go.dev/github.com/unselfishmaso/human-readable-json-logging/slogtotext)
...
You can find examples of using the library in [documentation](https://pkg.go.dev/github.com/unselfishmaso/human-readable-json-logging/slogtotext).
...
```sh
go install -v github.com/unselfishmaso/human-readable-json-logging/cmd/...@latest
```
...
This issue has to be solved by [this commit](https://github.com/unselfishmaso/human-readable-json-logging/commit/c8ce47a67812e8f616b0c23a7b1abc2fced15461),
